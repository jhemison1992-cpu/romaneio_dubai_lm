import { mysqlTable, int, varchar, text, timestamp, mysqlEnum, date, json } from "drizzle-orm/mysql-core";
...
export const inspectionItems = mysqlTable("inspection_items", {
  ...
  responsibleConstructionPhotoUrl: varchar("responsible_construction_photo_url", { length: 1000 }),
  responsibleConstructionPhotoKey: varchar("responsible_construction_photo_key", { length: 500 }),
  responsibleSupplierPhotoUrl: varchar("responsible_supplier_photo_url", { length: 1000 }),
  responsibleSupplierPhotoKey: varchar("responsible_supplier_photo_key", { length: 500 }),
  deliveryTermSignature: text("delivery_term_signature"),
  deliveryTermResponsible: varchar("delivery_term_responsible", { length: 255 }),
  deliveryTermResponsiblePhotoUrl: varchar("delivery_term_responsible_photo_url", { length: 1000 }),
  deliveryTermResponsiblePhotoKey: varchar("delivery_term_responsible_photo_key", { length: 500 }),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});

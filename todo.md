...
## Mostrar Evolução da Instalação para TODOS os Ambientes

- [ ] Modificar lógica para criar inspection_items automaticamente ao carregar ambiente
- [ ] Garantir que todos os ambientes mostrem a seção "Evolução da Instalação"
- [ ] Criar inspection_items para ambientes existentes que não têm
- [ ] Testar em todos os ambientes (incluindo Abrigo de Gás)
- [ ] Verificar que a seção aparece mesmo antes de salvar dados

## Mostrar Evolução da Instalação para TODOS os Ambientes

- [x] Opção 1: Criar inspection_items para todos os ambientes existentes via SQL
- [x] Opção 2: Modificar lógica para criar inspection_items automaticamente ao carregar ambiente
- [x] Garantir que todos os ambientes mostrem a seção "Evolução da Instalação"
- [x] Testar em todos os ambientes (incluindo Abrigo de Gás, Entrada Social)
- [x] Verificar que a seção aparece mesmo antes de salvar dados
- [x] Criar função autoCreateInspectionItems no backend
- [x] Adicionar endpoint inspections.autoCreateItems
- [x] Adicionar useEffect no frontend para chamar automaticamente
